...
- URL: https://huggingface.co/spaces/Chris4K/mcp_images_graio_client
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/mcp_images_graio_client/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/mcp_images_graio_client
